...
class BasicAuth(Auth):
    """ A class for BasicAuth"""
    def extract_base64_authorization_header(self, header: str) -> str:
    ...
    def extract_user_credentials(
        ...
        """It extracts user credentials from a decoded Base64 string"""
